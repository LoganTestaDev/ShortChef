      ...
      <div id="bodyWrapper">
         ...
         <div class="breadcrumbs inner-body-wrapper">
            <ul class="breadcrumbs-nav">
               ...
               <li><a href="checkerboard-salad.php">Checkerboard Salad</a></li>
            </ul>
         </div>
         <div class="content-container inner-body-wrapper">
            <div class="content-row content-row-pad">
               <div class="ingredients-content">
                  ...
                  <h3 class="page-sub-header major-subheading row-two">Checkerboard Salad</h3>
                  ...
                  <p>Remember that tomatoes are a fruit, which they are botanically, so this combination of fruits and veggies with fresh herbs goes great together. Important to 
                     always toss this salad together before serving. The picture of the presentation to create a checkerboard of the ingredients. So have some fun, and it does take some time.
                  </p>
                  <div class="subpage-content">
                     <div class="content-lar-5 left-col">
                        <div class="supporting-photo-container checkerboard-salad"></div>
                     </div>
                     ...
                     <div class="instructions-sub-container">
                        <div class="instructions-inner-sub-container">
                           ...
                           <div class="content-med-12">
                              <div class="instructions-item">Combine the tomatoes, cucumber, watermelon, avocado, and Fresh Herbs.</div>
                           </div>
                           <div class="clear-both"></div>
                        </div>
                     </div>
                  ...
                  <div class="instructions-container">
                     <div class="instructions-sub-container">
                        <div class="instructions-inner-sub-container">
                           ...
                           <div class="content-med-12">
                              <div class="instructions-item">In a small bowl, whisk together the olive oil, balsamic vinegar, and salt and pepper to taste.</div>
                           </div>
                           <div class="clear-both"></div>
                        </div>
                     </div>
                  ...
                  <div class="instructions-container">
                     <div class="instructions-sub-container">
                        <div class="instructions-inner-sub-container">
                           ...
                           <div class="content-med-12">
                              <div class="instructions-item">Pour over the tomato mixture and toss to coat evenly.</div>
                           </div>
                           <div class="clear-both"></div>
                        </div>
                     </div>
                  ...
                  <div class="instructions-container">
                     <div class="instructions-sub-container">
                        <div class="instructions-inner-sub-container">
                           ...
                           <div class="content-med-12">
                              <div class="instructions-item">On a flat plate or platter begin to build your checkerboard…have fun!</div>
                           </div>
                           <div class="clear-both"></div>
                        </div>
                     </div>
                  ...
                  <div class="instructions-container">
                     <div class="instructions-sub-container">
                        <div class="instructions-inner-sub-container">
                           ...
                           <div class="content-med-12">
                              <div class="instructions-item">This recipe serves 5 people.</div>
                           </div>
                           <div class="clear-both"></div>
                        </div>
                     </div>
