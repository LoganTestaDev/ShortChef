         ...
         <div class="content-container inner-body-wrapper">
            <div class="content-row content-row-pad">
               <div class="content-med-12">
                  <div class="page-header-container">
                     ...
                     <h1 class="row-two">Peanut Butter and Jelly on a Roll</h1>
                  </div>
                  <div class="breadcrumbs">
                     <ul class="breadcrumbs-nav">
                        <li><a href="index.php">Short Chef</a></li>
                        <li><a href="recipes-short-chef.php">Recipes</a></li>
                        <li><a href="pbj-on-a-roll.php">PBJ On a Roll</a></li>
                     </ul>
                  </div>
               </div>
            ...
            <div class="content-row content-row-pad">
               <div class="ingredients-content">
                  <div class="subpage-content">
                     <div class="content-lar-8 left-col">
                        <div class="supporting-photo-container pbj-on-a-roll"></div>
                     </div>
               ...
               <div class="instructions-content">
                  <h4>Step 1:</h4>
                  <p>Open your hot dog roll and smear peanut butter on one side</p>
                  <h4>Step 2:</h4>
                  <p>Smear your Jelly on the other side</p>
                  <h4>Step 3:</h4>
                  <p>Peel a banana and place it on your roll</p>
                  <h4>Step 4:</h4>
                  <p>top with some crunchy granola</p>
