         ...
         <div class="content-container inner-body-wrapper">
            <div class="content-row content-row-pad">
               <div class="content-med-12">
                  <h3 class="page-sub-header major-subheading">Build a Healthy Plate</h3>
                  <p>Before you eat, think about what goes on your plate or in your cup or bowl. Foods like vegetables, fruits, whole grains, low-fat dairy products, 
                     and lean protein foods contain the nutrients you need without too many calories. Try some of these options.
                  </p>
                  <div id="restaurantEatingGuide">
                     <img class="center-image" src="assets/images/myplate1.jpg" alt="1: Portion Control" />
                     ...
                     <hr/>
                     <img class="center-image" src="assets/images/myplate2.jpg" alt="2: Order Foods to Go" />
                     <ul class="generic-list">
                     ...
                     <hr/>
                     <img class="center-image" src="assets/images/myplate3.jpg" alt="3: Try the Light Menu" />
                     <ul class="generic-list">
                     ...
                     <hr/>
                     <img class="center-image" src="assets/images/myplate4.jpg" alt="3: Try the Light Menu" />
                     <ul class="generic-list">
