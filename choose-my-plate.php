         ...
         <div class="content-container inner-body-wrapper">
            ...
            <div class="content-row content-row-pad">
               <div class="content-med-12">
                  ...
                  <div class="content-med-6">
                     <div class="supporting-photo-container choose-my-plate"></div>
                  </div>
                  <div class="clear-both"></div>
               </div>
               <div class="content-med-12">
                  <div id="restaurantEatingGuide">
                     <div class="instructions-content subsection-content-items">
                        ...
                        <h3>Make Half Your Plate Fruits and Vegetables.</h3>
                     ...
                     <div class="instructions-content subsection-content-items">
                        ...
                        <h3>Switch to skim or 1% milk.</h3>
                        <ul class="generic-list">
                     ...
                     <div class="instructions-content subsection-content-items">
                        ...
                        <h3>Make at least half your grains whole.</h3>
                        <ul class="generic-list">
                     ...
                     <div class="instructions-content subsection-content-items">
                        <div class="number-disc">
                           <div class="number-disc-item">4</div>
                        </div>
                        <h3>Vary your protein food choices.</h3>
                        <ul class="generic-list">
